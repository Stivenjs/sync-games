...
pub fn register_all_commands(builder: Builder<Wry>) -> Builder<Wry> {
    builder.invoke_handler(tauri::generate_handler![
        ...
        crate::config::config_cmds::get_overlay_position,
        crate::config::config_cmds::set_overlay_position,
        crate::config::config_cmds::get_overlay_settings,
        crate::config::config_cmds::set_overlay_settings,
        crate::config::config_cmds::get_gamepad_ignore_background,
        crate::config::config_cmds::set_gamepad_ignore_background,
        crate::config::config_cmds::get_torrent_rate_limits,
        crate::config::config_cmds::set_torrent_rate_limits,
        crate::config::config_cmds::get_torrent_seeding_mode,
        crate::config::config_cmds::set_torrent_seeding_mode,
        crate::config::config_cmds::get_auto_sync_on_game_exit,
        crate::config::config_cmds::set_auto_sync_on_game_exit,
